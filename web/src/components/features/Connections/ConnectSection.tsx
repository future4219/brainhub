...
import { CLITokensSection } from "@/components/features/Connections/CLITokensSection";
...
import {
  codexConnectCommand,
  connectionSteps,
} from "@/components/features/Connections/connectionSetup";
    ...
    <div className="mt-6">
      ...
      {props.config && props.viewer && props.connection && (
        <div className="max-w-copy space-y-6">
          ...
          <CLITokensSection
            {...props}
            mcpURL={props.config.mcp_url}
            tokens={props.connection.cli_tokens}
          />
          <details>
