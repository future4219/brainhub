...
export function connectionSteps(mcpURL: string, clientID: string | null): ConnectionStep[] {
  return [
    ...
    { number: "03", title: "作られたコネクタを編集し、Client ID を貼る", body: clientID ? "失敗したコネクタの OAuth Client ID 欄に貼って保存する。シークレットは不要。" : "先に「Claude Webの接続を準備」で Client ID を作り、OAuth Client ID 欄に貼る。", code: clientID ?? undefined },
